...
import dataProfileUserService from '../services/users/dataProfileUser.service';
...
const dataProfileUserController = async (req:Request,res:Response) => {
  const user = await dataProfileUserService(req.params.id)
