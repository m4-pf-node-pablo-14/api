...
const listUsersService = async (
  ...
  const postsAndFollowersCountArray = mergeUserCountArrays(postsCount, followersCount)

  const rowsOfCount = mergeUserCountArrays(postsAndFollowersCountArray, followingCount)
