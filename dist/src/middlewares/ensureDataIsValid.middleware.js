...
const ensureDataIsValidMiddleware = (schema) => (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        if (!message) {
            throw new AppError_1.default('message was not sent');
        }
        const messageValidated = yield schema.validate(message, {
            abortEarly: false,
            stripUnknown: true,
        });
...
//# sourceMappingURL=ensureDataIsValid.middleware.js.map