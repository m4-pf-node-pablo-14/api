...
__decorate([
    (0, typeorm_1.ManyToOne)(() => user_entities_1.default, (user) => user.likes, {
        cascade: true,
        onDelete: 'CASCADE',
    }),
...
__decorate([
    (0, typeorm_1.ManyToOne)(() => posts_entities_1.default, (post) => post.likes, {
        cascade: true,
        onDelete: 'CASCADE',
    }),
...
//# sourceMappingURL=likes.entities.js.map