...
const listUsersWithSameFollowerService = (tokenId) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const users = yield userQueryBuilder
        .leftJoinAndSelect(follow_entities_1.default, 'follow', 'follow.followersId = users.id')
        .where('follow.followersId = :tokenId', { tokenId })
        .getMany();
    return users;
});
exports.default = listUsersWithSameFollowerService;
//# sourceMappingURL=listUsersWithSameFollower.service.js.map