...
const createPostsService = (postData, requesterUserId) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const post = postsRepository.create(Object.assign(Object.assign({}, postData), { user }));
    yield postsRepository.save(post);
    return post;
});
exports.default = createPostsService;
//# sourceMappingURL=createPosts.service.js.map